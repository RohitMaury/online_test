...
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
	<td><b><span title="This quiz is already solve by you" class="title1 pull-right sub1" style="margin:0px;border-radius: 5px;background-color: #67d8c1;text-align:center;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;Done</span></b></td></tr>';
}
}
$c=0;
echo '</table></div></div>';
